...
class Ultimate_Adv_Accordion extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'fields' => [
                    [
                        'name'         => 'ultimate_adv_accordion_tab_default_active',
                    ...
                    [
                        'name'         => 'ultimate_accordion_show_tab_icon',
                    ...
                    [
                        'name'      => 'ultimate_accordion_tab_title_icon',
                    ...
                    [
                        'name'    => 'ultimate_adv_accordion_tab_title',
                    ...
                    [
                        'name'    => 'ultimate_accordion_text_type',
                    ...
                    [
                        'name'      => 'ultimate_primary_templates',
                    ...
                    [
                        'name'      => 'ultimate_adv_accordion_tab_content',
	...
	>
		<?php
			...
			<?php if ('content' == $tab['ultimate_accordion_text_type']): ?>
				<p><?php echo do_shortcode($tab['ultimate_adv_accordion_tab_content']); ?></p>
			    <?php
...
Plugin::instance()->widgets_manager->register_widget_type( new Ultimate_Adv_Accordion() );