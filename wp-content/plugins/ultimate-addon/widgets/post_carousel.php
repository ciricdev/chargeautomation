...
class Ultimate_Post_Carousel extends Widget_Base {
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => __( 'Typography', 'ultimate' ),
                    'scheme'   => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
                    'selector' => '{{WRAPPER}} .ultimate__single__post ul.post__meta li,.ultimate__single__post .post__author__thumb__link a',
                ]
            );
            $this->add_group_control(
                Group_Control_Background:: get_type(),
                [
                    ...
                    'label'    => __( 'Background', 'ultimate' ),
                    'types'    => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .ultimate__single__post ul.post__meta',
                ]
            );
            $this->add_group_control(
                Group_Control_Border:: get_type(),
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__post ul.post__meta' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                ]
            );
            $this->add_responsive_control(
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .ultimate__single__post .post__btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                ...
                <div <?php echo $this->get_render_attribute_string( 'ultimate_post_slider_attr' ); ?>>
                    ...
                    ?>
                        ...
                        <?php elseif( $settings['post_carousel_style'] == 5 ): ?>
                            ...
                            <div <?php echo $this->get_render_attribute_string( 'ultimate_post_slider_item_attr' ); ?> >
                                <?php $this->ultimate_render_loop_content( 5 ); ?>
                            </div>

                        <?php elseif( $settings['post_carousel_style'] == 6 ): ?>

                            <div <?php echo $this->get_render_attribute_string( 'ultimate_post_slider_item_attr' ); ?> >
                                <?php $this->ultimate_render_loop_content( 6 ); ?>
                            </div>
        ...
        $settings   = $this->get_settings_for_display(); ?>
            ...
            <?php elseif( $contetntstyle == 4 ) : ?>
                ...
                <div class="post__content">
                    <div class="post__inner">
                        <?php $this->ultimate_post_category(); ?>
                        <?php $this->ultimate_post_date(); ?>
                        <?php $this->ultimate_post_title(); ?>
                        <?php $this->ultimate_post_content(); ?>
                        <?php $this->ultimate_post_author(); ?>
                    </div>
                </div>
    ...
    public function ultimate_post_date(){
        $settings   = $this->get_settings_for_display(); ?>
        <?php if( $settings['show_author'] == 'yes' || $settings['show_date'] == 'yes'): ?>
            <ul class="post__meta">
                <?php if( $settings['show_date'] == 'yes' ):?>
    ...
    public function ultimate_post_author(){
        $settings   = $this->get_settings_for_display(); ?>
        <?php if( $settings['show_author'] == 'yes' ): ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new Ultimate_Post_Carousel() );