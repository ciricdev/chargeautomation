...
class Ultimate_Give_Campains_Widget extends Widget_Base {

    public function get_name() {
        return 'Ultimate_Give_Campains_Widget';
    }
    
    public function get_title() {
        return __( 'Give Campains', 'ultimate' );
    }
    ...
    public function ultimate_get_taxonomies( $ultimate_texonomy = 'campaigncats' ){
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'label_block' => true,
                    'multiple'    => true,
                    'options'     => $this->ultimate_get_taxonomies(),
                    'condition'   => [
                        'carousel_post_type' => 'give_forms',
                    ]
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'label_block' => true,
                    'multiple'    => true,
                    'options'     => $this->ultimate_get_taxonomies('product_cat'),
                    'condition'   => [
            ...
            $this->add_control(
                'show_progressbar',
                [
                    'label'        => esc_html__( 'Show Progressbar', 'ultimate' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default'      => 'yes',
                ]
            ...
            $this->add_control(
                'show_fact',
                [
                    'label'        => esc_html__( 'Show Fact', 'ultimate' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default'      => 'yes',
                ]
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'default'   => 1,
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain' => 'margin: calc( {{VALUE}}px / 2 );',
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .ultimate__single__campain',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain' => 'overflow:hidden;border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors'          => [
                        '{{WRAPPER}} .ultimate__single__campain' => 'margin-top: {{TOP}}{{UNIT}}; margin-bottom:{{BOTTOM}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain:nth-child(2n)' => 'margin-top: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain:hover' => 'transform: translateY({{SIZE}}{{UNIT}});',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain .campain__content' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Background', 'ultimate' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .ultimate__single__campain .campain__content',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain .campain__content' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain .campain__content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain .campain__content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain .campain__content' => 'text-align: {{VALUE}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain .campain__content .post__title a' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain .campain__content .post__title a:hover' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => __( 'Typography', 'ultimate' ),
                    'scheme'   => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
                    'selector' => '{{WRAPPER}} .ultimate__single__campain .campain__content .post__title',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain .campain__content .post__title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain .campain__content .post__title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain .campain__content .post__title' => 'text-align: {{VALUE}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => __( 'Count Text Typography', 'ultimate' ),
                    'scheme'   => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
                    'selector' => '{{WRAPPER}} .ultimate__single__campain .campain__prgressbar .count',
                ]
            );
            $this->add_group_control(
                Group_Control_Background:: get_type(),
                [
                    ...
                    'label'    => __( 'Progressbar Background', 'ultimate' ),
                    'types'    => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .ultimate__single__campain .campain__prgressbar',
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'types'    => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .ultimate__single__campain .campain__prgressbar .count__bar',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain .campain__prgressbar' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                'progressbar_height',
                [
                    'label'      => __( 'Progressbar Height', 'ultimate' ),
                    'type'       => Controls_Manager::SLIDER,
                    'size_units' => [ 'px', '%' ],
                    'range'      => [
                        'px' => [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain .campain__prgressbar' => 'height: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                'progress_height',
                [
                    'label'      => __( 'Prgress Height', 'ultimate' ),
                    'type'       => Controls_Manager::SLIDER,
                    'size_units' => [ 'px', '%' ],
                    'range'      => [
                        'px' => [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain .campain__prgressbar .count__bar' => 'height: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                'progressbar_margin',
                [
                    'label'      => __( 'Progressbar Margin', 'ultimate' ),
                    'type'       => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain .campain__prgressbar' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                'progress_margin',
                [
                    'label'      => __( 'Progress Margin', 'ultimate' ),
                    'type'       => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain .campain__prgressbar .count__bar' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain .campain__prgressbar' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => __( 'Typography', 'ultimate' ),
                    'scheme'   => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
                    'selector' => '{{WRAPPER}} .ultimate__single__campain .ultimate__fact__wrap',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain .ultimate__fact__wrap' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain .ultimate__fact__wrap' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain .ultimate__fact__wrap' => 'text-align: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'separator' => 'before',
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain .goal__fact .campain__fact__count' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => __( 'Typography', 'ultimate' ),                    
                    'scheme'   => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
                    'selector' => '{{WRAPPER}} .ultimate__single__campain .goal__fact .campain__fact__count',
                ]
            );
            $this->add_responsive_control(
                'goal_margin',
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain .goal__fact .campain__fact__count' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'separator' => 'before',
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain .raised__fact .campain__fact__count' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_group_control(
                ...
                [
                    ...
                    'scheme'   => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
                    'selector' => '{{WRAPPER}} .ultimate__single__campain .raised__fact .campain__fact__count',
                ]
            );
            $this->add_responsive_control(
                'raised_margin',
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain .raised__fact .campain__fact__count' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'separator' => 'before',
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain .donor__fact .campain__fact__count' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_group_control(
                Group_Control_Typography:: get_type(),
                [
                    'name'     => 'donor_typography',
                    'label'    => __( 'Typography', 'ultimate' ),
                    
                    'scheme'   => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
                    'selector' => '{{WRAPPER}} .ultimate__single__campain .donor__fact .campain__fact__count',
                ]
            );
            $this->add_responsive_control(
                'donor_margin',
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain .donor__fact .campain__fact__count' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Typography', 'ultimate' ),
                            'scheme'   => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
                            'selector' => '{{WRAPPER}} .ultimate__single__campain .post__category li a',
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .ultimate__single__campain .post__category li a' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .ultimate__single__campain .post__category li a' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .ultimate__single__campain .post__category li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .ultimate__single__campain .post__category li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .ultimate__single__campain .post__category li a:hover' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Background', 'ultimate' ),
                            'types'    => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .ultimate__single__campain .post__category li a:hover',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .ultimate__single__campain .post__category li a:hover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => __( 'Typography', 'ultimate' ),
                    'scheme'   => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
                    'selector' => '{{WRAPPER}} .ultimate__single__campain ul.post__meta li',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain ul.post__meta'                           => 'color: {{VALUE}}',
                        '{{WRAPPER}} .ultimate__single__campain ul.post__meta a' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain ul.post__meta li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .ultimate__single__campain ul.post__meta li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .ultimate__single__campain ul.post__meta' => 'justify-content: {{VALUE}};',
                    ],
                ]
            );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .ultimate__single__campain .post__btn a.readmore__btn' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Typography', 'ultimate' ),
                            'scheme'   => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
                            'selector' => '{{WRAPPER}} .ultimate__single__campain .post__btn a.readmore__btn',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .ultimate__single__campain .post__btn a.readmore__btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .ultimate__single__campain .post__btn a.readmore__btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .ultimate__single__campain .post__btn a.readmore__btn' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .ultimate__single__campain .post__btn a.readmore__btn:hover' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Background', 'ultimate' ),
                            'types'    => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .ultimate__single__campain .post__btn a.readmore__btn:hover',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .ultimate__single__campain .post__btn a.readmore__btn:hover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'ultimate_items_wrap_attr', 'class', 'ultimate__campain__content__layout-'.$settings['post_carousel_style'] );
        $this->add_render_attribute( 'ultimate_single_item_attr', 'class', 'ultimate__single__campain ultimate__campain__layout__'.$settings['post_carousel_style'] );


        // Slider options
        if( $settings['slider_on'] == 'yes' ){
            $this->add_render_attribute( 'ultimate_items_wrap_attr', 'class', 'sldier-content-area'.' '.$settings['nav_position'] );
            $this->add_render_attribute( 'ultimate_post_style_type_activation_wrap_attr', 'class', 'ultimate-carousel-activation' );
            ...
            $this->add_render_attribute( 'ultimate_post_style_type_activation_wrap_attr', 'data-settings', wp_json_encode( $slider_settings ) );
        }
        ...
        if( !empty($settings['carousel_prod_categories']) ){
            ...
            $get_categories = $settings['campain_categories'];
        }
        ...
        if (  !empty( $get_categories ) ) {
            if( is_array($carousel_cats) && count($carousel_cats) > 0 ){
                ...
                $args['tax_query']  = array(
                    array(
                        'taxonomy'         => ( $settings['carousel_post_type'] == 'product' ) ? 'product_cat' : 'campaigncats',
                        'terms'            => $carousel_cats,
                        'field'            => $field_name,
        ...
        ?>
            <div <?php echo $this->get_render_attribute_string( 'ultimate_items_wrap_attr' ); ?>>
                <div <?php echo $this->get_render_attribute_string( 'ultimate_post_style_type_activation_wrap_attr' ); ?>>
                    ...
                    ?>
                        ...
                        <?php if( $settings['post_carousel_style'] == 1 ): ?>
                            ...
                            <div <?php echo $this->get_render_attribute_string( 'ultimate_single_item_attr' ); ?> >
    ...
    public function ultimate_render_loop_content( $contetntstyle = NULL ){
        $settings   = $this->get_settings_for_display(); ?>
            ...
            <?php if( $contetntstyle == 1 ) : ?>
                ...
                <?php $this->ultimate_goal_prgressbar(); ?>
                <?php $this->ultimate_post_texonomy_retrive(); ?>
                <div class="campain__content">
                    <div class="campain__inner">
                        <?php $this->ultimate_post_meta(); ?>
                        <?php $this->ultimate_post_title(); ?>
                        <?php $this->ultimate_campain_facts(); ?>
        ...
        <?php if( $settings['show_author'] == 'yes' || $settings['show_date'] == 'yes'): ?>
            <ul class="post__meta">
                ...
                <?php if( $settings['show_author'] == 'yes' ): ?>
                    <li class="author__meta"><?php echo get_avatar( get_the_author_meta( 'ID'), $size = 50, $default = '', $alt = '', $args = null );?><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ), get_the_author_meta( 'user_nicename' ) ); ?>"><?php the_author();?></a></li>
                <?php endif; ?>
    ...
    public function ultimate_texonomy_filter_menu($texonomy = 'campaigncats'){
        $terms = get_terms($texonomy);
        if ( ! is_wp_error( $terms ) && ! empty( $terms ) ) { ?>
           <ul class="post__filter__menu">
    ...
    public function ultimate_post_texonomy_retrive($texonomy = 'campaigncats'){
        ...
        if ( ! is_wp_error( $terms ) && ! empty( $terms ) ) { ?>
           <ul class="post__category">
            <?php foreach ($terms as $term) : ?>
                <li><a href="<?php echo get_term_link($term->slug, $texonomy ); ?>"><?php echo $term->name; ?></a></li>
            <?php endforeach; ?>
            </ul>
            <?php
        }
    ...
    public function ultimate_goal_prgressbar(){
        ...
        $donors_counts       = $form->get_sales();
        $donors_counts       = ( !empty($donors_counts) ? $donors_counts : 0 );

        if( isset($progress_bar_value) ){
            echo'<div class="campain__prgressbar" data-percent="'.esc_attr($progress_bar_value).'%">
    ...
    public function ultimate_campain_facts(){

        $camp_author_name  = get_the_author();
        $camp_author_photo = get_avatar( get_the_author_meta('user_email') );
        if ( has_excerpt( get_the_ID() ) ) {
            // Get excerpt from the form post's excerpt field.
            $raw_content      = get_the_excerpt( get_the_ID() );
        ...
        $income_format_args = apply_filters( 'give_goal_income_format_args',
            array(
                'sanitize' => false,
        ...
        $goal_format_args = apply_filters( 'give_goal_amount_format_args',
            array(
                'sanitize' => false,
                'currency' => $form_currency,
                'decimal'  => false,
        ...
        $camp_raised  = give_currency_filter( $income, array( 'form_id' => get_the_ID() ) );
        $camp_pledged = give_currency_filter( $goal, array( 'form_id' => get_the_ID() ) );
        echo '<div class="ultimate__fact__wrap">';        
        if( !empty($camp_pledged) ){
            echo '<div class="single__campain__fact goal__fact">
                <span class="campain__fact__count">'.esc_html($camp_pledged).'</span>
                <span class="campain__fact__title">'.esc_html__('Goal','ultimate').'</span>
            </div>';
        }
        if( !empty($camp_raised) ){
            echo '<div class="single__campain__fact raised__fact">
                <span class="campain__fact__count">'.esc_html($camp_raised).'</span>
                <span class="campain__fact__title">'.esc_html__('Raised','ultimate').'</span>
            </div>';
        }
        if( isset($donors_counts) ){
            echo '<div class="single__campain__fact donor__fact">
                <span class="campain__fact__count">'.esc_html($donors_counts).'</span>
                <span class="campain__fact__title">'.esc_html__('Donors','ultimate').'</span>
            </div>';
        }
        echo '</div>';
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new Ultimate_Give_Campains_Widget() );