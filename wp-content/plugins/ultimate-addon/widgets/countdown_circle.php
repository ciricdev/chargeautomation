...
class Ultimate_Countdown_Circle_Widget extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'circle_bg_color',
			[
				'label'   => __( 'Circle Bg Color', 'ultimate' ),
		...
		$this->add_control(
			'days_circle_color',
			[
				'label'   => __( 'Days Circle Color', 'ultimate' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#ef296c',
			]
		);
		...
		$this->add_control(
			'hours_circle_color',
			[
				'label'   => __( 'Hours Circle Color', 'ultimate' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#18bfc3',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => __( 'Minutes Circle Color', 'ultimate' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#ffd200',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => __( 'Seconds Circle Color', 'ultimate' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#182eff',
			]
		);
...
Plugin::instance()->widgets_manager->register_widget_type( new Ultimate_Countdown_Circle_Widget() );