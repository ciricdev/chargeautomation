...
class Ultimate_Box_Widget extends Widget_Base {
    ...
    public static function box_style(){
        return [
            ...
            'single__box__layout__2'      => 'Box Style 2',
            'single__box__layout__3'      => 'Box Style 3',
            'single__box__layout__4'      => 'Box Style 4',
            'single__box__layout__5'      => 'Box Style 5',
            'single__box__layout__6'      => 'Box Style 6',
            'single__box__layout__7'      => 'Box Style 7',
            'single__box__layout__8'      => 'Box Style 8',
            'single__box__layout__9'      => 'Box Style 8',
            'single__box__layout__10'     => 'Box Style 10',
            'single__box__layout__11'     => 'Box Style 11',
            'single__box__layout__12'     => 'Box Style 12',
            'single__box__layout__13'     => 'Box Style 13',
            'single__box__layout__14'     => 'Box Style 14',
            'single__box__layout__15'     => 'Box Style 15',
            'single__box__layout__16'     => 'Box Style 16',
            'single__box__layout__17'     => 'Box Style 17',
            'single__box__layout__18'     => 'Box Style 18',
	...
	protected function _register_controls() {
		...
		**********************************/
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Icon ( Before / After )', 'ultimate' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_icon' => 'yes',
				],
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'type'   => Controls_Manager::COLOR,
					'scheme' => [
						'type'  => \Elementor\Core\Schemes\Color::get_type(), // \Elementor\Core\Schemes\Color::get_type(),
						'value' => \Elementor\Core\Schemes\Color::COLOR_1, // \Elementor\Core\Schemes\Color::COLOR_1,
					],
					'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Box ( Before / After )', 'ultimate' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
...
Plugin::instance()->widgets_manager->register_widget_type( new Ultimate_Box_Widget() );