...
class Ultimate_Teams extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder'   => __( 'https://facebook.com/mehedidb', 'ultimate' ),
				'show_external' => true,
				'default'       => [
					'url'         => '',
					'is_external' => true,
		...
		$repeater->add_control(
			...
			[
				...
				'type'          => Controls_Manager::URL,
				'placeholder'   => __( 'https://twitter.com/mehedidb', 'ultimate' ),
				'show_external' => true,
				'default'       => [
					'url'         => '',
					'is_external' => true,
		...
		$repeater->add_control(
			'google_url',
			[
				'label'         => __( 'Google Plus Url', 'ultimate' ),
				'type'          => Controls_Manager::URL,
				'placeholder'   => __( 'https://plus.google.com/mehedidb', 'ultimate' ),
				'show_external' => true,
				'default'       => [
					'url'         => '',
					'is_external' => true,
		...
		$repeater->add_control(
			...
			[
				...
				'type'          => Controls_Manager::URL,
				'placeholder'   => __( 'https://youtube.com/mehedidb', 'ultimate' ),
				'show_external' => true,
				'default'       => [
					'url'         => '',
					'is_external' => true,
		...
		$repeater->add_control(
			...
			[
				...
				'type'          => Controls_Manager::URL,
				'placeholder'   => __( 'https://vimeo.com/mehedidb', 'ultimate' ),
				'show_external' => true,
				'default'       => [
					'url'         => '',
					'is_external' => true,
		...
		$repeater->add_control(
			...
			[
				...
				'type'          => Controls_Manager::URL,
				'placeholder'   => __( 'https://instagram.com/mehedidb', 'ultimate' ),
				'show_external' => true,
				'default'       => [
					'url'         => '',
					'is_external' => true,
		...
		$repeater->add_control(
			...
			[
				...
				'type'          => Controls_Manager::URL,
				'placeholder'   => __( 'https://linkedin.com/mehedidb', 'ultimate' ),
				'show_external' => true,
				'default'       => [
					'url'         => '',
					'is_external' => true,
		...
		$repeater->add_control(
			...
			[
				...
				'type'          => Controls_Manager::URL,
				'placeholder'   => __( 'https://pinterest.com/mehedidb', 'ultimate' ),
				'show_external' => true,
				'default'       => [
					'url'         => '',
					'is_external' => true,
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'member_name' => __( 'Mehdi Hasan', 'ultimate' ),
						'designation' => __( 'Web Developer' ),
					],
					[
						'member_name' => __( 'Niloy Khan', 'ultimate' ),
						'designation' => __( 'Web Developer' ),
					],
					[
						'member_name' => __( 'Abdur Rohman', 'ultimate' ),
						'designation' => __( 'CEO' ),
					],
					[
						'member_name' => __( 'Imon Ahmed', 'ultimate' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Content Warp', 'ultimate' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		if ($settings['team_content']) {
			...
			foreach( $settings['team_content'] as $team ){
				...
				<div class="single__team">';
					...
					if ( 'team__style__8' == $settings['team_style'] ) :
					$team_content .='
		...
		if ( count( $settings['team_content'] ) > 1 ) {
...
Plugin::instance()->widgets_manager->register_widget_type( new Ultimate_Teams() );